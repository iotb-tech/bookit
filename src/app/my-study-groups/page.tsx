    ...
    <AppShell>
      <main className="px-6 py-8 sm:px-8 lg:px-10 lg:py-10">
        <div className="mx-auto max-w-6xl">
          <Link href="/dashboard" className="inline-flex items-center gap-2 text-sm font-medium text-slate-500 transition hover:text-primary-700">
          ...
          <h1 className="mt-4 text-3xl font-bold tracking-tight text-slate-800">Manage your study groups</h1>
